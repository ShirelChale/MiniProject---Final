...
class GeometriesTests {
	...
	void testGeometries() {
		...
		List<GeoPoint> resultTC01 = collectionTC01.findIntersections(new Ray(new Point3D(0.5,1,-1), new Vector(0,0,1)));
		...
		List<GeoPoint> resultTC11 = collectionTC11.findIntersections(new Ray(new Point3D(1, 1, 1), new Vector(3, 3, 3)));
		...
		List<GeoPoint> resultTC12 = collectionTC12.findIntersections(new Ray(new Point3D(10,10,10), new Vector(0,1,0)));
		...
		List<GeoPoint> resultTC13 = collectionTC13.findIntersections(new Ray(new Point3D(0,0,1), new Vector(0,0,1)));
		...
		List<GeoPoint> resultTC14 = collectionTC14.findIntersections(new Ray(new Point3D(1,2,-1), new Vector(0,0,1)));
